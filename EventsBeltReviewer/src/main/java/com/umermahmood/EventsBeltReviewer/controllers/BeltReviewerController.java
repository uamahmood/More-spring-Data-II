package com.umermahmood.EventsBeltReviewer.controllers;
...
import com.umermahmood.EventsBeltReviewer.services.BeltReviewerService;
import com.umermahmood.EventsBeltReviewer.validators.UserValidator;
...
public class BeltReviewerController {
	...
	public String register(@Valid @ModelAttribute("userObj") User user, 
